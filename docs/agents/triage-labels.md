...
The engineering skills use five canonical triage roles. This repository keeps the default role names as its GitHub label strings.
...
When a skill names a canonical role, use the matching GitHub label from this table.
